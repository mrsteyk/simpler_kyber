...
REM if "%KYBER768_CLEAN%" == "1" (
REM echo Building kyber768 clean
REM clang %KYBER_CFLAGS% ../pqclean/kyber768/clean/amalgamated.c -c -o kyber768_clean.o
REM )

REM

if "%KYBER768_AVX2%" == "1" (
echo Building kyber768 AVX2
