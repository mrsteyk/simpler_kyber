...
void PQCLEAN_KYBER768_AVX2_shake128x4_absorb_once(keccakx4_state *state,
                                                  const uint8_t *in0,
                                                  const uint8_t *in1,
                                                  const uint8_t *in2,
                                                  const uint8_t *in3,
...
void PQCLEAN_KYBER768_AVX2_shake256x4_absorb_once(keccakx4_state *state,
                                                  const uint8_t *in0,
                                                  const uint8_t *in1,
                                                  const uint8_t *in2,
                                                  const uint8_t *in3,
...
void PQCLEAN_KYBER768_AVX2_shake128x4(uint8_t *out0,
    ...
    PQCLEAN_KYBER768_AVX2_shake128x4_absorb_once(&state, in0, in1, in2, in3, inlen);
...
void PQCLEAN_KYBER768_AVX2_shake256x4(uint8_t *out0,
    ...
    PQCLEAN_KYBER768_AVX2_shake256x4_absorb_once(&state, in0, in1, in2, in3, inlen);
