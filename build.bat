...
set LINK_OPTS=kyber768_clean.o
...
clang -gcodeview -fdiagnostics-absolute-paths -DNDEBUG -fuse-ld=lld -flto -fno-exceptions -fno-unwind-tables -fno-asynchronous-unwind-tables -march=native -mtune=native -std=c11 -O2 -g -I../pqclean ../src/main.c %LINK_OPTS% -o simpler_kyber.exe -lAdvapi32 -DKYBER768_AVX2=%KYBER768_AVX2%
popd
